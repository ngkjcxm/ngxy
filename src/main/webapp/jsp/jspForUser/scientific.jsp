                                    ...
                                    <form action="#" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" placeholder="奖励名称">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                ...
                                                                <option value="Category 2">国务院</option>
                                                                <option value="Category 3">教育部</option>
                                                                <option value="Category 4">山东省人民政府</option>
                                                                <option value="Category 4">山东省教育厅</option>
                                                                <option value="Category 4">淄博市人民政府</option>
                                                                <option value="Category 4">山东理工大学府</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="首位完成人">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-6 font-red-sunglo">获奖年度</label>
                                                        <div class="col-md-6">
                                                            <div class="input-group date form_year col-md-13"  data-date="" data-date-format="yyyy">
                                                                <input type="text" size="16" class="form-control">
                                                                <span class="input-group-btn">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1"></option>
                                                                <option value="Category 2">国家最高科学技术奖</option>
                                                                <option value="Category 3">国家自然科学奖</option>
                                                                <option value="Category 4">国家技术发明奖</option>
                                                                <option value="Category 4">国家科技进步奖</option>
                                                                <option value="Category 4">山东省最高科学技术奖</option>
                                                                <option value="Category 4">山东省自然科学奖</option>
                                                                <option value="Category 2">山东省自然科学奖</option>
                                                                <option value="Category 3">山东省技术发明奖</option>
                                                                <option value="Category 4">山东省科技进步奖</option>
                                                                <option value="Category 4">高等学校科学研究优秀成果奖（科学技术）自然科学奖</option>
                                                                <option value="Category 4">高等学校科学研究优秀成果奖（科学技术）技术发明奖</option>
                                                                <option value="Category 4">高等学校科学研究优秀成果奖（科学技术）科技进步奖</option>
                                                                <option value="Category 4">高等学校科学研究优秀成果奖（科学技术）专利奖</option>
                                                                <option value="Category 4">高等学校科学研究优秀成果奖（自然科学类）</option>
                                                                <option value="Category 4">校科技进步奖</option>
                                                                <option value="Category 4">淄博市技术发明奖</option>
                                                                <option value="Category 4">淄博市科技进步奖</option>
                                                                <option value="Category 4">校科技进步奖</option>
                                                                <option value="Category 4">国际合作奖</option>
                                                                <option value="Category 4">其他</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1"></option>
                                                                <option value="Category 1">特等奖</option>
                                                                <option value="Category 1">一等奖</option>
                                                                <option value="Category 1">二等奖</option>
                                                                <option value="Category 1">三等奖</option>
                                                                <option value="Category 1">其他</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1"></option>
                                                                <option value="Category 1">第一单位</option>
                                                                <option value="Category 1">第二单位</option>
                                                                <option value="Category 1">第三单位</option>
                                                                <option value="Category 1">第四单位</option>
                                                                <option value="Category 1">第五单位</option>
                                                                <option value="Category 1">第六单位</option>
                                                                <option value="Category 1">第七单位</option>
                                                                <option value="Category 1">第八单位</option>
                                                                <option value="Category 1">第九单位</option>
                                                                <option value="Category 1">第十单位</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="其他完成人">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="单位证书附件">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1"></option>
                                                                <option value="Category 2">通过</option>
                                                                <option value="Category 3">未通过</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
