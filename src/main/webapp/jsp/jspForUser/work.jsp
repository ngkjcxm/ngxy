                                                ...
                                                <div class="col-md-12">
                                                    <table id="user" class="table table-bordered  " style="text-align:center;" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:15%">
                                                                <input type="text" class="form-control" placeholder="著作名称">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:30%;font-size:15px;text-align:center;">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <h3 class="form-section font-red-sunglo">著作成果信息录入</h3>
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-6 font-red-sunglo">第一作者单位</label>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第一作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5 font-red-sunglo">撰写字数(千字)</label>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="撰写字数(千字)">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                ...
                                                                <option value="Category 2">专著</option>
                                                                <option value="Category 3">编著</option>
                                                                <option value="Category 4">教科书</option>
                                                                <option value="Category 4">电子出版物</option>
                                                                <option value="Category 4">译注</option>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5 font-red-sunglo">总字数(千字)</label>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="总字数(千字)">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1"></option>
                                                                <option value="Category 2">国内</option>
                                                                <option value="Category 3">国外</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="出版单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1">教育学</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5 font-red-sunglo">津贴发放年度</label>
                                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第二作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-5 ">撰写字数(千字)</label>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="撰写字数(千字)">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第三作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第四作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第五作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第六作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第七作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="第八作者单位">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
