                                                ...
                                                <div class="col-md-12">
                                                    <table id="user" class="table table-bordered  " style="text-align:center;" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:15%">
                                                                <input type="text" class="form-control" placeholder="专利名称">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:30%;font-size:15px;text-align:center;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1">发明</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="申请号（专利号）">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="专利权人">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" placeholder="授权公告号">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                <option value="Category 1">授权</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" placeholder="其他发明人或设计人">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" placeholder="专利证书附件">
