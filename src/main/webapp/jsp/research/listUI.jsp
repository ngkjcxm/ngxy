                ...
                <div class="col-md-8">
                    <div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
                        <div class="tab-content">
                            <form name="form" action="${basePath}research_check.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input name="scientificResearchReward.awardDate" type="date"
                                                                       class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date form_year col-md-13"  data-date="" data-date-format="yyyy">
                                                                    <s:textfield type="text" name="scientificResearchReward.allowance" class="form-control"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4 ">其他完成人</label>
                                                            <div class="col-md-6">
                                                                <s:textfield
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6" style="border:0px solid #ee1100;">
                                                                <s:if test="%{scientificResearchReward.headImg !=null && scientificResearchReward.headImg !='' }">
                                                                    <img src="/upload/<s:property value='scientificResearchReward.headImg'/>" width="250" height="250">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-5 font-red-sunglo">登记时间</label>
                                                            <div class="col-md-7">
                                                                <input name="scientificResearchReward.registerDate" type="date"
                                                                       class="form-control"
                                                    ...
                                                    <div class="col-md-12 " style="border:0px solid green;">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <input type="submit" class="btn green"onclick="javascript:return confirm('您确认要提交该科研成果吗？');" />
