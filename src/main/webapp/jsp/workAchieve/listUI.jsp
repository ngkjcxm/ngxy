    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <i class="fa fa-circle"></i>
                    <a style="text-decoration:none;">著作成果相关</a>
                </li>
                <li>
                    <i class="fa fa-circle"></i>
                    <a style="text-decoration:none;">著作成果审核</a>
                </li>
            </ul>
            <!-- END PAGE BREADCRUMB -->
            <!-- END PAGE HEADER-->
                                        ...
                                        <div class="col-md-12">
                                            <table id="user" class="table table-bordered  " style="text-align:center;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:15%">
                                                        <input name="search.workName" type="text" class="form-control" placeholder="著作名称">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:30%;font-size:15px;text-align:center;">
                                                    ...
                                                    <td style="width:15%">
                                                        <select name="search.academicUnit1Name"  class="select2_category form-control">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover"
                                                        ...
                                                        <c:forEach var="o" items="${pageList}">
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    <a href="/workAchieve/workAchieve/detail/${o.id}.html">
                                                                            ${o.workName} </a>
                                                                </td>
                                                                <td>
                                                                        ${o.author1Name}
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group date form_month col-md-13">
                                                                    <input name="workAchieve.publishDate" type="date" value="<s:date name="workAchieve.publishDate" format="yyyy-MM-dd"/>" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date form_day2 col-md-13">
                                                                    <input name="workAchieve.registerDate" value="<s:date name="workAchieve.registerDate" />" type="date"class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date form_day2 col-md-13">
                                                                    <input name="workAchieve.examineDate" value="<s:date name="workAchieve.examineDate" />" type="date"class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 " style="border:0px solid green;">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <a href="javascript:form.action='/workAchieve/workAchieve/save.html';form.submit()" class="btn green">提交</a>
                                                                <a href="javascript:form.action='/workAchieve/workAchieve/delete.html';form.submit()" class="btn red">删除</a>
