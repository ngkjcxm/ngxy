                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_2">
                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form name="form" method="post" action="/software/software/check.html" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4 ">津贴发放年度</label>
                                                            <div class="col-md-6">
                                                                <div class="input-group date form_year col-md-12"  data-date="" data-date-format="yyyy">
                                                                    <s:textfield type="text" name="software.allowanceYear" class="form-control"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6" style="border:0px solid #ee1100;">
                                                                <s:if test="%{software.headImg !=null && software.headImg !='' }">
                                                                    <img src="/upload/<s:property value='software.headImg'/>" width="250" height="250">
                                                    ...
                                                    <div class="col-md-12 " style="border:0px solid green;">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <input class="btn green" type="submit" onclick="javascript:return confirm('您确认要提交该软件成果吗？');" />
