                                            ...
                                            <form method="post"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <s:textfield id="funds"
                                                                                 name="vertical.approvalFunds"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="control-label col-md-2">其他成员</label>
                                                                <div class="col-md-10">
                                                                    <a data-target="#otherPeopleWindow"
                                                                       data-toggle="modal">
                                                                        <s:textfield id="otherPeopleInput"
                                                                                     name="vertical.otherPeople"
                                                                                     type="text"
                                                                                     class="form-control"
                                                                                     placeholder="其他成员"/>
                                                                    </a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <s:textfield name="vertical.examinePeoName"
                                                                                 type="text"
                                                                                 class="form-control"
                                                                                 placeholder="审核人"/>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input name="vertical.endTopicExamineDate"
                                                                           type="date"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-7">
                                                                    <input id="intoFunds" name="funds.intoFunds"
                                                                           type="text"
                                                                           class="form-control" placeholder="项目负责人">
                                                                </div>
                                                            </div>
                    ...
                    <div class="row select-pad">
                        ...
                        <div class="menu">
                            <ul class="list-group text-center">
                                <a id="add" href="javascript:;" class="list-group-item"
                                   title="右移"><strong>＞＞</strong></a>
