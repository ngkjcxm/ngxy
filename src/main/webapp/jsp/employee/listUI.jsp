                ...
                <div class="col-md-3">
                    <div class="portlet red box">
                        ...
                        <div class="portlet-body">
                            ...
                            <div data-spy="scroll" data-target="#navbar-example2" data-offset="0" class="scrollspy-example" style="height:375px;">
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="tab-pane active" id="tab_2">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="${basePath }employee_save.action" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="border:0px solid #ee1100;">
                                                        <s:if test="%{employee.headImg !=null && employee.headImg !='' }">
                                                            <img src="/upload/<s:property value='employee.headImg'/>" width="250" height="250">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">管理归属单位</label>
                                                        <div class="col-md-9">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">所属学院部门</label>
                                                        <div class="col-md-9">
                                                            <s:textfield name="employee.departmentName" type="text"
                                                                         class="form-control" placeholder="管理归属"/>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    jQuery(document).ready(function () {
        // 添加树
        $.get('/employee/employee/treeForEmpty.html', function (data) {
