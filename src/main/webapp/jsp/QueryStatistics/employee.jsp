                                        ...
                                        <form action="#" class="form-horizontal">
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    ...
                                                                    <option value="Category 1">助教</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">学院</label>
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value="Category 1">山东理工大学</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">单位</label>
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">学位</label>
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value="Category 1"></option>
                                                                    <option value="Category 1">本科</option>
                                                                    <option value="Category 1">硕士</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">政治面貌</label>
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value="Category 1"></option>
                                                                    <option value="Category 1">党员</option>
                                                                    <option value="Category 1">非党员</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
