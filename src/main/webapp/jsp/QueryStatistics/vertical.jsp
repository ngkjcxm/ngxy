    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <i class="fa fa-circle"></i>
                    <a style="text-decoration:none;">纵向课题信息统计</a>
                </li>
            </ul>
            <!-- END PAGE BREADCRUMB -->
            <!-- END PAGE HEADER-->
                                        ...
                                        <form action="#" class="form-horizontal">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">到款年度</label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    ...
                                                                    <option value="Category 1">哲学</option>
                                                                    <option value="Category 2">理论经济学</option>
                                                                    <option value="Category 1">应用经济学</option>
                                                                    <option value="Category 2">法学</option>
                                                                    <option value="Category 2">政治学</option>
                                                                    <option value="Category 2">民族学</option>
                                                                    <option value="Category 2">教育学</option>
                                                                    <option value="Category 2">中国语言文学</option>
                                                                    <option value="Category 2">外国语言文学</option>
                                                                    <option value="Category 2">新闻传播学</option>
                                                                    <option value="Category 2">艺术学</option>
                                                                    <option value="Category 2">历史学</option>
                                                                    <option value="Category 2">数学</option>
                                                                    <option value="Category 2">物理学</option>
                                                                    <option value="Category 2">化学</option>
                                                                    <option value="Category 2">天文学</option>
                                                                    <option value="Category 2">地理学</option>
                                                                    <option value="Category 2">大气科学</option>
                                                                    <option value="Category 2">海洋科学</option>
                                                                    <option value="Category 2">地球物理学</option>
                                                                    <option value="Category 2">心理学</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">参与类型</label>
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value="Category 1"></option>
                                                                    <option value="Category 1">主持</option>
