    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <i class="fa fa-circle"></i>
                    <a style="text-decoration:none;">软件著作权信息统计</a>
                </li>
            </ul>
            <!-- END PAGE BREADCRUMB -->
            <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-body form">
                                        ...
                                        <form action="#" class="form-horizontal">
                                            <div class="form-body">
                                                <h3 class="form-section font-red-sunglo">软件著作权信息统计</h3>

                                                <!--/row-->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">软件著作权名称</label>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4 ">证书号</label>
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">登记号</label>
                                                            <div class="col-md-6">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                                    <option value="Category 1"></option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4 ">第一作者性别</label>
                                                            <div class="col-md-8">
                                                                <select class="select2_category form-control" data-placeholder="Choose a Category" tabindex="1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">发证日期</label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-6 ">首次发表日期</label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" placeholder="">
                                                            </div>
                                                        </div>
